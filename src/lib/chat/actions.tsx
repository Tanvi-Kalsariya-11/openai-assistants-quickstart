...
import { BotCard, Spinner, BotMessage, SystemMessage } from "@/components";
import { Stock } from "@/components/Stock";
import { Purchase } from "@/components/StockPurchase";
...
async function submitUserMessage(content: string) {
  ...
  try {
    const chatGPTResponse = (await getChatGPTResponse(messages)) as any;
    const { choices } = chatGPTResponse;
...
export const AI = createAI<AIState, UIState>({
  ...
  initialUIState: messages as any,
